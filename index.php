...
<body onload="document.getElementById('usuario').focus()">
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5 img">
        <a href="#" class="navbar-brand ps-5 me-0 align-items-center">
                            ...
                            <div class="form-outline mb-4">
                                <div class="mb-4">
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="password" id="contrasena" class="form-control Input" name="contrasena" maxlength="10" required>   
                                    </div>
                                </div>
                            </div>
                        </div>
